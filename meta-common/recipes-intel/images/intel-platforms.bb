...
inherit ${@bb.utils.contains('IMAGE_FSTYPES', 'intel-secboot', 'image_types_intel_secure_boot', '', d)}

DEPENDS += "${@bb.utils.contains('IMAGE_FSTYPES', 'intel-pfr', 'obmc-intel-pfr-image-native', '', d)}"
DEPENDS += "${@bb.utils.contains('IMAGE_FSTYPES', 'intel-secboot', 'obmc-intel-pfr-image-native', '', d)}"

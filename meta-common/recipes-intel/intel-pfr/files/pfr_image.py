...
# json_file, firmware_file
    def __init__(self, manifest, firmware_file, build_ver, build_num, build_hash, sha, output_filename):
        ...
        platform_conf = self.manifest.get('platform-conf')
        if platform_conf:
            self.pfm_rev = platform_conf['pfm-rev']
            #TO-DO : Platform_id will be used for the future platforms
            #self.platform_id = platform_conf['platform-id']
        else :
            self.pfm_rev = 0xff
    ...
    def build_pfm(self):
        ...
        '''
        names = [
            'tag', 'sec_rev', 'bkc', 'pfm_ver_major', 'pfm_ver_minor', 'resvd0', 'build_num', 'build_hash1', 'build_hash2', 'build_hash3','pfm_rev' ,'resvd1', 'pfm_len',
            ]
        parts = {
            ...
            'pfm_rev':struct.pack('<B', self.pfm_rev),
            'resvd1': b'\xff'* 11,
            'pfm_len': ''
            }
